<template>
  <div class="about-part" ref="about">
    <div class="user reveal-left">
      <div class="user-info">
        <ul>
          <li><i class="iconfont icon-people"></i>
            <p>我是Collin, 专注前端开发</p>
          </li>
          <li><i class="iconfont icon-position"></i>
            <p>暂居魔都</p>
          </li>
          <li><i class="iconfont icon-love"></i>
            <p>喜欢Coding，美剧，罗小黑</p>
          </li>
      ...
      <div class="user-image">
        <div class="image">
          <a href="https://github.com/TJCollinZhang"><img src="/static/images/avatar.jpg" alt="collin"></a>
        </div>
    ...
    mounted() {
      ...
      this.$nextTick(() => {
        ...
        MP('vAtU2iOAVVl8i2GySRLSiEOO8ts3u7ds').then(BMap => {
          ...
          var myGeo = new BMap.Geocoder();
          // 将地址解析结果显示在地图上，并调整地图视野
          myGeo.getPoint("中兴通讯大厦", function (point) {
              if (point) {
