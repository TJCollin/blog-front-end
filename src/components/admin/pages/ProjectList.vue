  ...
  <div class="list-box">
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="项目图标">
        <template slot-scope="scope">
          <i style="display: block; padding-left: 20px;" :class="scope.row.projectIcon? `iconfont ${scope.row.projectIcon}`:''"></i>
    ...
    <el-dialog title="新增项目" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" label-width="120px" ref="projectForm" @keyup.enter.native="submitForm">
        ...
        <el-form-item label="项目图标">
          <ul>
            <li>
              <el-button @click="changeIcon('icon-vue')" :class="form.projectIcon === 'icon-vue'?'focused-button':''">
                <i class="iconfont icon-vue"></i>
              </el-button>
            </li>
            <li>
              <el-button @click="changeIcon('icon-node')" :class="form.projectIcon === 'icon-node'?'focused-button':''">
                <i class="iconfont icon-node"></i>
              </el-button>
            </li>
            <li>
              <el-button @click="changeIcon('icon-react')" :class="form.projectIcon === 'icon-react'?'focused-button':''">
                <i class="iconfont icon-react"></i>
              </el-button>
            </li>
            <li>
              <el-button @click="changeIcon('icon-angular')" :class="form.projectIcon === 'icon-angular'?'focused-button':''">
